...
const Page5 = () => {
  return (
    <div className='relative w-full h-250 bg-black text-white flex flex-col items-center justify-start overflow-hidden rounded-4xl'>
      ...
      <div className="relative w-[1050px] h-[550px]">
        <svg
            width="100%"
            height="100%"
