...
export const Timeline = ({ data }) => {
  ...
  return (
    <div
      className="w-full bg-black  font-sans md:px-10 mb-10"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-10 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          I&apos;ve been working on my computational thinking and skills. Here&apos;s
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20 h-screen overflow-scroll scrollbar-hide">
        {data.map((item, index) => (
          ...
          >
            {/* Left side timeline dots + titles */}
        ...
        <div
          ...
          className="absolute md:left-8 left-8 top-10 overflow-hidden w-0.5 
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-2 bg-linear-to-t 
